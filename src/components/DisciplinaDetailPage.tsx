...
export const DisciplinaDetailPage: React.FC<DisciplinaDetailPageProps> = ({
  ...
  const handleAddLivroRecomendado = (e: React.FormEvent) => {
    ...
    addLivroRecomendado({
      ...
      added_by_name: normalizedEmail.includes('ary') ? 'Profº Ary Júnior' : normalizedEmail.includes('robson') || normalizedEmail.includes('sacra') ? 'Profº Robson Rocha' : normalizedEmail.includes('camila') ? 'Monitora Camila' : normalizedEmail.includes('cristiano') ? 'Monitor Cristiano' : 'Docente / Coordenação',
  ...
  const handleAddLeitura = (e: React.FormEvent) => {
    ...
    addAnnouncement({
      ...
      author_name: normalizedEmail.includes('ary') ? 'Profº Ary Júnior' : normalizedEmail.includes('robson') || normalizedEmail.includes('sacra') ? 'Profº Robson Rocha' : normalizedEmail.includes('camila') ? 'Monitora Camila' : normalizedEmail.includes('cristiano') ? 'Monitor Cristiano' : 'Docente / Coordenação',
  ...
  const handleAddGeminiNote = (e: React.FormEvent) => {
    ...
    addGeminiNote({
      ...
      author_name: normalizedEmail.includes('camila') ? 'Monitora Camila' : normalizedEmail.includes('cristiano') ? 'Monitor Cristiano' : normalizedEmail.includes('ary') ? 'Profº Ary Júnior' : normalizedEmail.includes('robson') ? 'Profº Robson Rocha' : 'Monitoria / Docente',
      author_role: currentRole === 'admin' ? 'admin' : currentRole === 'monitor' ? 'monitor' : 'professor',
      author_email: normalizedEmail,
    });
