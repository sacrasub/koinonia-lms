...
export const PROFESSOR_RECOMMENDED_LIBRARY_BOOKS: BibliotecaBook[] = [
  ...
  },
  {
    ...
    author: 'Profº Alexsandro (Org.)',
    category: '14 - Sociologia e Ciências Afins',
    size: 3890000,
    date: '2026-08-25T20:00:00.000Z',
    mime: 'application/pdf',
    path: 'História da Cultura Afro Brasileira e Indígena/Coletânea de Textos.pdf',
    drive_url: 'https://drive.google.com/drive/folders/1mCp4ZCawhIekLJl3_bcoPiThAqwdzlty?usp=drive_link',
    description: 'Textos, artigos e leis que fundamentam o debate sobre etnia, fé e história nacional. Recomendado pelo Profº Alexsandro.',
