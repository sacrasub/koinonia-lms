...
export const GOOGLE_AGENDA_EVENTS: GoogleAgendaEvent[] = [
  ...
  },
  {
    ...
    disciplinaId: 'disc-9',
    code: 'AFR-101',
    title: 'Cultura Afro e Indígena - Profº Alexsandro (Modular)',
    professorName: 'Profº Alexsandro',
    professorEmail: 'alexsandro@koinonia.edu.br',
    monitorName: 'Cristiano',
    dayOfWeek: 'Sexta-feira',
    dayOfWeekIndex: 5,
    startTime: '21:00',
    ...
    bgLight: 'bg-amber-50/50',
    borderLight: 'border-amber-200/80',
    recurrenceRule: 'Modular: 4 aulas gravadas no Drive (Entrega até 28 nov. 2026)',
    googleMeetUrl: '',
    googleMeetCode: '',
    phoneBridge: '',
    phonePin: '',
    ...
    pendingGuests: 10,
    organizerEmail: 'ead@uiecbead.com.br',
    description: 'Matéria modular com 4 aulas gravadas no Drive. Na 4ª aula, o Profº Alexsandro explica a atividade que deve ser enviada por e-mail até 28/11/2026.',
    ...
    attachments: [
      {
        id: 'att-09-drive',
        title: 'Cultura Afro & Indígena • 4 Aulas (Drive Oficial)',
        type: 'drive',
        url: 'https://drive.google.com/drive/folders/1mCp4ZCawhIekLJl3_bcoPiThAqwdzlty?usp=drive_link',
        iconType: 'drive'
      },
      {
        id: 'att-09-docs',
